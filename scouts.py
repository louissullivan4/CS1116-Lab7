...
print("""
    <!DOCTYPE html>
        ...
        <head>
            <meta charset="utf-8" />
            <title>Ballygunner Database: Scouts</title>
            <link rel="stylesheet" href="styles.css">
        </head>
        <header>
          <h1>19th Waterford Ballygunner: Scouts</h1>
        </header>
        <body>
            <nav>
                <ul>
            ...
            <nav id="update">
                <ul>
                    <li><a href="add_scout.py">Add Scouts</a></li>
                    <li><a href="drop_scout.py">Delete Scouts</a></li>
                </ul>
            </nav>
        </body>
    </html>""" % (result))
