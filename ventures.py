    ...
    if http_cookie_header:
        ...
        if 'sid' in cookie:
            ...
            if session_store.get('authenticated'):
                ...
                result = '<table id="scout-table"><tr><th>Forename</th><th>Surname</th><th>Date of Birth</th><th>Gender</th><th>Address</th><th>Parent/Guardian Forename</th><th>Parent/Guardian Surname</th><th>Parent/Guardian Number</th><th>Parent/Guardian Email</th><th>Subs Per Paid (out of 4): </th></tr>'
...
print("""
    <!DOCTYPE html>
        <html lang="en">
            <head>
                <meta charset="utf-8" />
                <title>Ballygunner Database: Ventures</title>
                <link rel="stylesheet" href="styles.css">
            </head>
            <header>
                <h1>19th Waterford Ballygunner: Ventures</h1>
            </header>
            <body>
        		<nav>
        			<ul>
                ...
                <nav id="update">
                    <ul>
                        <li><a href="add_scout.py">Add Ventures</a></li>
                        <li><a href="drop_scout.py">Delete Ventures</a></li>
                    </ul>
                </nav>
            </body>
        </html>""" % (result))
